...
def catalog_data(url,description_dir):
    # Function will return a list of dictionaries with all the details: name, weight, description, image_name.
    # Change the weight to integer format.
...
# Upload all the data to the web service
